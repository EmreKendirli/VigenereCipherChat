...
import "../../helper/encrypt.js"
import  "../../helper/decrypt.js"
// import "../../helper/encrypt.js"
// import "../../helper/decrypt.js"
import { decryptText,encryptText } from "../../helper/encryption.js"
...
const sendMessage = tryCatch(async (req,res)=>{
    ...
    // Use: 'Hello World!'.encrypt('mysecretkey')
    // // console.log("a",a);
    // const b = a.decrypt('mysecretkey')
    // console.log("b",b);

    // const decryptedText = decryptMessage('Zijvw Gnhvh!', 'mysecretkey');
    const text = req.body.text
    console.log("text",text)
    const encryptText = text.encryptMessage(req.body.key1)
    console.log("Encrypt",encryptText);
    const decryptedText = encryptText.decryptMessage(req.body.key2);
